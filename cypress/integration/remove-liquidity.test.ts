describe('Remove Liquidity', () => {
  it('redirects', () => {
    cy.visit('/remove/0x03e10D5e4a072dFE4ae4347E403720373417734D-0xF9bA5210F91D0474bd1e1DcDAeC4C58E359AaD85')
    cy.url().should(
      'contain',
      '/remove/0x03e10D5e4a072dFE4ae4347E403720373417734D/0xF9bA5210F91D0474bd1e1DcDAeC4C58E359AaD85'
    )
  })
  ...
  it('does not crash if ETH is duplicated', () => {
    cy.visit('/remove/0x03e10D5e4a072dFE4ae4347E403720373417734D-0x03e10D5e4a072dFE4ae4347E403720373417734D')
    cy.get('#remove-liquidity-tokena-symbol').should('contain.text', 'WETH')
